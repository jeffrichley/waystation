...
Amended in [#32](https://github.com/jeffrichley/waystation/issues/32): `.extra_refs()` stores `travelling_refs`, not `visible_refs` — the glossary moved under ADR-0037, and this decision's own rule follows the glossary.
