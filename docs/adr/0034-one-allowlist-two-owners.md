...
Decided while grilling [#73](https://github.com/jeffrichley/waystation/issues/73), out of the architecture review in [#69](https://github.com/jeffrichley/waystation/issues/69).
